  ...
  return (
    <div className="relative group shrink-0">
      ...
      <Button
        ...
        className="absolute -top-1.5 -right-1.5 size-4 bg-surface border border-border/50 rounded-full text-text-muted hover:text-signal-error opacity-0 group-hover:opacity-100 transition-all"
      >
